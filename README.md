...
```mermaid
graph TD
    %% Määritellään graafin tyyli ja akselit
    %% Pystyakseli (Y): Aika (logaritminen asteikko)
    %% Vaaka-akseli (X): Entropia bitteinä
    
    %% Graafin visualisointi (SVG/PNG)
    
    subgraph "Salasanan Entropia vs. Brute-force Aika"
        A[Aika murtaa] -->|Log asteikko| B{ }
        B --> |1 m| C1[40b: Sekunteja]
        B --> |1 v| C2[55b: Kuukausia/Vuosia]
        B --> |1000 v| C3[70b: Vuosituhansia]
        B --> |1 mrd v| C4[90b: Ikuisuus]
        B --> |Universumin ikä| C5[128b: Mahdoton]
        
        %% Määritellään x-akselin pisteet
        ...
        %% Yhdistetään pisteet viivalla
        P20( ) -- Heikko --> P45( )
        P45( ) -- Kohtalainen --> P60( )
        P60( ) -- Vahva --> P80( )
        P80( ) -- Erit. vahva --> P128( )
        
        %% Sijoitetaan generaattorin 98b piste
        P98(Sinun 98b) -.-> P80
    end
    ...
    style D4 fill:#0ff,stroke:#000,stroke-width:2px,stroke-dasharray: 5 5;
    ```
